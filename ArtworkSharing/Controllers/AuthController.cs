    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login(UserToLoginDto userToLoginDTO)
        {
            try
            {
                ...
                bool isEmailActivated = await _userManager.IsEmailConfirmedAsync(user);
                if (!isEmailActivated)
        ...
        public async Task<IActionResult> Register(UserToRegisterDto userToRegisterDTO)
        {
            try
            {
                ...
                await _emailSender.SendEmailAsync(user.Email, "Confirm your email", $"Please confirm your email by clicking <a href='{confirmationLink}'>here</a>", IsBodyHtml: true);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Reset Password",
                                       GetEmailBodyForResetPassword(callbackUrl), IsBodyHtml: true);
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordModel model)
        {
            ...
            if (user == null)
            {
                return BadRequest("User not found. Please check your email address.");
            }
