    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("013878db-2066-4246-80af-d2ce6022f797"), null, "SuperAdmin", "SUPERADMIN" },
                    { new Guid("1b73e8c1-20d8-4bff-836b-b94eec9f08cc"), null, "Audience", "AUDIENCE" },
                    { new Guid("f7b3b099-d460-4cea-8480-73f0a3d13094"), null, "Artist", "ARTIST" },
                    { new Guid("ff3d6a5c-422c-43cb-86b2-9518b0bf7e40"), null, "Admin", "ADMIN" }
                });
